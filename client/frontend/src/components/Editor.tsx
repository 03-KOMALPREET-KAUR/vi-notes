...
const s: Record<string, React.CSSProperties> = {
  ...
  username: { color: '#e7dede', fontSize: 13 },
  logoutBtn: { background: 'transparent', border: '1px solid #222', color: '#f3ebeb', borderRadius: 6, padding: '5px 13px', fontSize: 12, cursor: 'pointer' },
